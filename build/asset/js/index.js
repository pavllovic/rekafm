...
/***/ "./asset/components/carousel/carousel.js":
/*!***********************************************!*\
  !*** ./asset/components/carousel/carousel.js ***!
  \***********************************************/
...
/* harmony export */ });
/* harmony import */ var Lib_carousel_carousel_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! Lib/carousel/carousel.js */ "./asset/lib/carousel/carousel.js");

var Carousel = Lib_carousel_carousel_js__WEBPACK_IMPORTED_MODULE_0__.carousel;
Carousel.prototype = {
  constructor: Carousel,
  init: Lib_carousel_carousel_js__WEBPACK_IMPORTED_MODULE_0__.init,
  setListeners: Lib_carousel_carousel_js__WEBPACK_IMPORTED_MODULE_0__.setListeners,
  nextSlide: Lib_carousel_carousel_js__WEBPACK_IMPORTED_MODULE_0__.nextSlide,
  prevSlide: Lib_carousel_carousel_js__WEBPACK_IMPORTED_MODULE_0__.prevSlide,
  changeSlide: Lib_carousel_carousel_js__WEBPACK_IMPORTED_MODULE_0__.changeSlide,
  activateSlide: Lib_carousel_carousel_js__WEBPACK_IMPORTED_MODULE_0__.activateSlide,
  deactivateSlide: Lib_carousel_carousel_js__WEBPACK_IMPORTED_MODULE_0__.deactivateSlide,
  disableControl: Lib_carousel_carousel_js__WEBPACK_IMPORTED_MODULE_0__.disableControl,
  undisableControl: Lib_carousel_carousel_js__WEBPACK_IMPORTED_MODULE_0__.undisableControl,
  handleEvent: Lib_carousel_carousel_js__WEBPACK_IMPORTED_MODULE_0__.handleEvent
};
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (Carousel);

/***/ }),

/***/ "./asset/components/form/OrderCallForm.js":
/*!************************************************!*\
  !*** ./asset/components/form/OrderCallForm.js ***!
  \************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/***/ "./asset/components/ownCarousel/ownCarousel.js":
/*!*****************************************************!*\
  !*** ./asset/components/ownCarousel/ownCarousel.js ***!
  \*****************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var Lib_ownCarousel_customOwnCarousel__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! Lib/ownCarousel/customOwnCarousel */ "./asset/lib/ownCarousel/customOwnCarousel.js");

var OwnCarousel = Lib_ownCarousel_customOwnCarousel__WEBPACK_IMPORTED_MODULE_0__.customOwnCarousel;
OwnCarousel.prototype = {
  constructor: OwnCarousel,
  init: Lib_ownCarousel_customOwnCarousel__WEBPACK_IMPORTED_MODULE_0__.init,
  setListeners: Lib_ownCarousel_customOwnCarousel__WEBPACK_IMPORTED_MODULE_0__.setListeners,
  translateSlide: Lib_ownCarousel_customOwnCarousel__WEBPACK_IMPORTED_MODULE_0__.translateSlide,
  moveSlide: Lib_ownCarousel_customOwnCarousel__WEBPACK_IMPORTED_MODULE_0__.moveSlide,
  resetSlide: Lib_ownCarousel_customOwnCarousel__WEBPACK_IMPORTED_MODULE_0__.resetSlide,
  openGallery: Lib_ownCarousel_customOwnCarousel__WEBPACK_IMPORTED_MODULE_0__.openGallery,
  closeGallery: Lib_ownCarousel_customOwnCarousel__WEBPACK_IMPORTED_MODULE_0__.closeGallery,
  debounce: Lib_ownCarousel_customOwnCarousel__WEBPACK_IMPORTED_MODULE_0__.debounce,
  adaptive: Lib_ownCarousel_customOwnCarousel__WEBPACK_IMPORTED_MODULE_0__.adaptive,
  updateSize: Lib_ownCarousel_customOwnCarousel__WEBPACK_IMPORTED_MODULE_0__.updateSize,
...
/***/ "./asset/lib/carousel/carousel.js":
/*!****************************************!*\
  !*** ./asset/lib/carousel/carousel.js ***!
  \****************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "activateSlide": () => (/* binding */ activateSlide),
/* harmony export */   "carousel": () => (/* binding */ carousel),
/* harmony export */   "changeSlide": () => (/* binding */ changeSlide),
/* harmony export */   "deactivateSlide": () => (/* binding */ deactivateSlide),
/* harmony export */   "disableControl": () => (/* binding */ disableControl),
...
/* harmony export */   "undisableControl": () => (/* binding */ undisableControl)
/* harmony export */ });
...
function setListeners() {
  ...
  this.controls.forEach(function (control) {
    control.addEventListener('click', _this);
  });
}
...
/***/ "./asset/lib/formValidator/formValidator.js":
/*!**************************************************!*\
  !*** ./asset/lib/formValidator/formValidator.js ***!
  \**************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
FormValidator.prototype = {
  ...
  setListeners: function setListeners() {
    ...
    this.fields.forEach(function (input) {
      input.addEventListener('input', _this.onInput.bind(_this));

      _this.addErrorTooltip(input);
    });
  },
  checkInput: function checkInput(input) {
    return input.checkValidity();
  },
  addErrorTooltip: function addErrorTooltip(input) {
  ...
  showErrorTooltip: function showErrorTooltip(input, errorText) {
    ...
    var errorMessage = tooltip.querySelector('.msg');
    ...
    setTimeout(function () {
      ...
      tooltip.style = "height: ".concat(errorMessage.offsetHeight, "px; opacity: 1");
    }, delay);
  },
  hideErrorTooltip: function hideErrorTooltip(input) {
    var tooltip = this.getErrorTooltip(input);
    tooltip.style.height = '0px';
  },
  showErrorMessage: function showErrorMessage(element) {
    var errorMessage = element;
    errorMessage.style.opacity = '1';
  },
  hideErrorMessage: function hideErrorMessage(element) {
    var errorMessage = element;
    errorMessage.style.opacity = '0';
  },
  getInputError: function getInputError(input) {
    var nameError = Object.keys(input.validity).filter(function (key) {
      return input.validity[key];
    });
    this.mapError.set(input.name, nameError);
  },
  validInputHandler: function validInputHandler(input) {
    this.mapError.clear();
    this.hideErrorTooltip(input);
    input.classList.remove('invalid');
    input.classList.add('valid');
  },
  invalidInputHandler: function invalidInputHandler(input) {
    var typeError = this.mapError.get(input.name);
  ...
  validateInput: function validateInput(input) {
    ...
    isValid ? this.validInputHandler(input) : this.invalidInputHandler(input);
  },
...
/***/ "./asset/lib/form/form-handlers.js":
/*!*****************************************!*\
  !*** ./asset/lib/form/form-handlers.js ***!
  \*****************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "fakeSendFormHandler": () => (/* binding */ fakeSendFormHandler),
/* harmony export */   "onErrorHandler": () => (/* binding */ onErrorHandler),
/* harmony export */   "onSuccessHandler": () => (/* binding */ onSuccessHandler),
/* harmony export */   "sendFormHandler": () => (/* binding */ sendFormHandler)
/* harmony export */ });
...
function sendFormHandler(form, data) {
  var _this = this;

  this.sendForm(form, data).then(function (res) {
    return _this.onSuccessHandler(res);
  })["catch"](function (err) {
    return _this.onErrorHandler(err);
  })["finally"](function () {
    _this.sending = false; // hide submitting

    if (_this.showSubmitting) _this.showSubmitting();
  });
} // fake request to server

function fakeSendFormHandler(form, data) {
  var _this2 = this;

  this.timeout = setTimeout(function () {
    _this2.sendForm(form, data).then(function (res) {
      return _this2.onSuccessHandler(res);
    })["catch"](function (err) {
      return _this2.onErrorHandler(err);
    })["finally"](function () {
      _this2.sending = false; // hide submitting

      if (_this2.showSubmitting) _this2.showSubmitting();
    });
  }, 5000);
}
...
/* harmony export */   "sendFormJSON": () => (/* binding */ sendFormJSON)
/* harmony export */ });
...
function sendFormJSON(_x3, _x4) {
  return _sendFormJSON.apply(this, arguments);
}

function _sendFormJSON() {
  _sendFormJSON = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2(form, data) {
    var objData, url, method, enctype, options, response;
    return regeneratorRuntime.wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            objData = Object.fromEntries(data);
            url = form.getAttribute('action'); // const url = 'https://echo.htmlacademy.ru';
            ...
            options = {
              ...
              headers: {
                'Content-Type': enctype // 'Content-Type': 'text/plain',
...
/* harmony export */   "handleEvent": () => (/* binding */ handleEvent),
/* harmony export */   "hideFormOverlay": () => (/* binding */ hideFormOverlay),
/* harmony export */   "hideFormResposne": () => (/* binding */ hideFormResposne),
/* harmony export */   "init": () => (/* binding */ init),
/* harmony export */   "resetForm": () => (/* binding */ resetForm),
/* harmony export */   "setListeners": () => (/* binding */ setListeners),
/* harmony export */   "showFormOverlay": () => (/* binding */ showFormOverlay),
/* harmony export */   "showFormResposne": () => (/* binding */ showFormResposne),
/* harmony export */   "showSubmitting": () => (/* binding */ showSubmitting),
...
function showFormOverlay() {
  var overlay = this.form.querySelector('#form-overlay');
...
function showFormResposne(text) {
  var elem = this.form.querySelector('#form-response');
  var messageElem = elem.querySelector('[data-response="text"]');
  messageElem.innerText = text;
  elem.classList.add('is-active');
}
function hideFormResposne() {
  var elem = this.form.querySelector('#form-response');
...
/***/ "./asset/lib/ownCarousel/customOwnCarousel.js":
/*!****************************************************!*\
  !*** ./asset/lib/ownCarousel/customOwnCarousel.js ***!
  \****************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "activateSlide": () => (/* binding */ activateSlide),
/* harmony export */   "adaptive": () => (/* binding */ adaptive),
/* harmony export */   "closeGallery": () => (/* binding */ closeGallery),
/* harmony export */   "createPickers": () => (/* binding */ createPickers),
/* harmony export */   "createTabsMap": () => (/* binding */ createTabsMap),
/* harmony export */   "customOwnCarousel": () => (/* binding */ customOwnCarousel),
...
var customOwnCarousel = function customOwnCarousel(elem, options, axis) {
  ...
  this.gapSize = (100 - this.options.itemPerRow * this.options.itemSize) / (this.options.itemPerRow - 1) || 0; // prevent divide 0

  this.wrap.style.setProperty('--size', "".concat(this.options.itemSize, "%"));
  this.wrap.style.setProperty('--margin', "".concat(this.gapSize, "%"));
  this.index = 0;
  this.carouselItem = this.carousel.children;
  this.imgSize = this.axis === 'X' ? this.carouselItem[0].getBoundingClientRect().width : this.carouselItem[0].getBoundingClientRect().height;
  this.numberOfItem = this.carouselItem.length;
  this.step = this.imgSize + this.gapSize / this.itemSize * this.imgSize; // calculate the step to translate
...
var createTabsMap = function createTabsMap() {
  ...
  this.tabs.querySelectorAll('[data-gallery="tab"]').forEach(function (item, i) {
    _this.tabsMap.set(item, i);
  });
};
var createPickers = function createPickers() {
  this.pickerItems = [];

  for (var i = 0; i < this.numberOfItem / this.itemPerRow; i += 1) {
...
var setListeners = function setListeners() {
  ...
  if (this.options.loop) {
    ...
    this.index = this.itemPerRow; // this.carousel.style.transform = `translate3d(${
    //   -this.index * this.step
    // }px,0,0)`;

    this.carousel.style.transform = "translate".concat(this.axis, "(").concat(-this.index * this.step, "px)");

    for (var i = 0; i < this.itemPerRow; i += 1) {
      var cloneNode = this.carouselItem[i].cloneNode(true);
    ...
    while (count !== this.itemPerRow) {
      var _cloneNode = this.carouselItem[this.numberOfItem - 1].cloneNode(true);

      this.carousel.insertAdjacentElement('afterbegin', _cloneNode);
      count += 1;
    }
  }
  ...
  if (this.options.autoplay) {
    timeoutId = setTimeout(function () {
      intervalId = setInterval(function () {
        return _this2.moveSlide(1);
      }, _this2.options.autoplay);
    }, 3000);

    if (this.options.stopAutoplayWhenHover) {
      this.carouselOuter.addEventListener('mouseenter', function () {
        clearTimeout(timeoutId);
        clearInterval(intervalId);
      });
      this.carouselOuter.addEventListener('mouseleave', function () {
        clearInterval(intervalId);
        clearTimeout(timeoutId);
        timeoutId = setTimeout(function () {
          intervalId = setInterval(function () {
  ...
  if (this.options.nav) {
    this.wrap.querySelector('.control__prev').addEventListener('click', function () {
      _this2.moveSlide(-1);
    });
    this.wrap.querySelector('.control__next').addEventListener('click', function () {
      _this2.moveSlide(1);
    });
  }

  if (this.options.mouseWheel) {
    this.carouselOuter.addEventListener('wheel', function (e) {
      e.preventDefault();
      if (e.deltaY > 0) _this2.moveSlide(-1);else _this2.moveSlide(1);
    });
  }
  ...
  if (this.options.draggable) {
    ...
    var currentPos = 0;
    var firstPos = currentPos;

    var dragHandle = function dragHandle(e) {
      var currentMove = parseFloat( // this.carousel.style.transform.slice(12),
      _this2.carousel.style.transform.slice(11)); // get the x-axis of transform3d

      var currentIndex = -currentMove / _this2.step; // const x = e.type === 'touchmove' ? e.touches[0].clientX : e.clientX;

      var x; // get current coordinate
      ...
      var distanceMoved = x - currentPos;

      if (_this2.options.loop) {
        if (currentIndex <= 0) {
          _this2.index = _this2.numberOfItem;

          _this2.translateSlide();
        } else if (currentIndex >= _this2.numberOfItem + _this2.itemPerRow) {
          _this2.index = _this2.itemPerRow;
          ...
          // }px,0,0)`;
          _this2.carousel.style.transform = "translate".concat(_this2.axis, "(").concat(currentMove + distanceMoved, "px)");
        }
      } else {
        ...
        currentIndex < 0 || currentIndex > _this2.numberOfItem - _this2.itemPerRow ? _this2.carousel.style.transform = "translate".concat(_this2.axis, "\n            (").concat(currentMove + distanceMoved / 5, "px)") : _this2.carousel.style.transform = "translate".concat(_this2.axis, "\n            (").concat(currentMove + distanceMoved, "px)");
      }

      currentPos = x;
    };

    var dragEndHandle = function dragEndHandle(e) {
      if (e.type === 'touchend') {
        ...
        _this2.carouselOuter.style.cursor = 'auto';
      } // remove unnecessary event listener and style


      var currentMove = parseFloat( // this.carousel.style.transform.slice(12),
      _this2.carousel.style.transform.slice(11));
      _this2.index = _this2.checkIndex(-currentMove);

      if (!_this2.options.loop) {
        if (_this2.index > _this2.numberOfItem - _this2.itemPerRow) {
          _this2.index = _this2.numberOfItem - _this2.itemPerRow;
        }

        if (_this2.index < 0) _this2.index = 0;
      }

      _this2.carousel.style.transition = 'all 0.6s cubic-bezier(0.165, 0.84, 0.44, 1)';
      ...
      if (_this2.options.autoplay) {
        ...
        timeoutId = setTimeout(function () {
          intervalId = setInterval(function () {
            return _this2.moveSlide();
          }, _this2.options.autoplay, 1);
        }, 2000);
      }
    };

    var dragStartHandle = function dragStartHandle(e) {
      _this2.carousel.style.transition = 'none';

      if (e.type === 'touchstart') {
        currentPos = _this2.axis === 'X' ? e.touches[0].clientX : e.touches[0].clientY;
        document.addEventListener('touchmove', dragHandle);
        document.addEventListener('touchend', dragEndHandle);
      } else {
        _this2.carouselOuter.style.cursor = 'grab';
        currentPos = _this2.axis === 'X' ? e.clientX : e.clientY;
        document.addEventListener('mousemove', dragHandle);
        document.addEventListener('mouseup', dragEndHandle);
      }

      firstPos = currentPos; // add necessary listener, style, reset first and current position
    ...
    this.checkIndex = function (currentMove) {
      var temp = currentMove;

      while (temp >= _this2.step) {
        temp -= _this2.step;
      }

      if (temp > 50 && firstPos - currentPos >= 0 || _this2.step - temp < 50 && firstPos - currentPos <= 0) return Math.ceil(currentMove / _this2.step);
      return Math.floor(currentMove / _this2.step);
    ...
    this.carouselOuter.addEventListener('touchstart', dragStartHandle); // i had to create carouselOuter because carousel will be hidden when slide is working
  }

  window.addEventListener('resize', this.debounce(function () {
    return _this2.adaptive();
  }, 500));
  ...
  if (this.tabs) {
    this.tabs.addEventListener('click', function (e) {
      if (e.target.getAttribute('data-gallery') === 'tab') _this2.activateSlide(e.target);
    });
  }
};
...
var translateSlide = function translateSlide() {
  // this.carousel.style.transform = `translate3d(${
  //   -this.index * this.step
  // }px,0,0)`;
  this.carousel.style.transform = "translate".concat(this.axis, "(").concat(-this.index * this.step, "px)");
...
var updateActivePicker = function updateActivePicker() {
...
var resetSlide = function resetSlide(step) {
  ...
  this.translateSlide(); // reset it silently by changing transition to none
...
var moveSlide = function moveSlide(step) {
  this.carousel.style.transition = 'all 0.6s cubic-bezier(0.165, 0.84, 0.44, 1)'; // every time we move slide, add transition
...
var adaptive = function adaptive() {
  ...
  for (var property in this.options.responsive) {
    //eslint-disable-line
  ...
  this.gapSize = (100 - this.itemPerRow * this.itemSize) / (this.itemPerRow - 1) || 0;
  if (this.gallery) this.gallery.style.setProperty('--g-width', "".concat(this.itemSize, "%"));
  this.wrap.style.setProperty('--size', "".concat(this.itemSize, "%"));
  this.wrap.style.setProperty('--margin', "".concat(this.gapSize, "%")); // divide into 2 phase to avoid wrong calculating for imgWidth

  this.imgSize = this.carouselItem[0].getBoundingClientRect().width;
  this.step = this.imgSize + this.gapSize / this.itemSize * this.imgSize; // change important property for responsive
...
/*!************************!*\
  ...
  \************************/
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var Styles_index_css__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! Styles/index.css */ "./asset/styles/index.css");
/* harmony import */ var _components_carousel_carousel_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./components/carousel/carousel.js */ "./asset/components/carousel/carousel.js");
/* harmony import */ var _components_ownCarousel_ownCarousel__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./components/ownCarousel/ownCarousel */ "./asset/components/ownCarousel/ownCarousel.js");
/* harmony import */ var _lib_formValidator_formValidator_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./lib/formValidator/formValidator.js */ "./asset/lib/formValidator/formValidator.js");
/* harmony import */ var _components_form_OrderCallForm_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./components/form/OrderCallForm.js */ "./asset/components/form/OrderCallForm.js");
...
var initFormOrderCall = function initFormOrderCall() {
  ...
  var formValidator = new _lib_formValidator_formValidator_js__WEBPACK_IMPORTED_MODULE_3__["default"](formElem);
...
var initOwnCarousel = function initOwnCarousel() {
  ...
  var ownCarousel = new _components_ownCarousel_ownCarousel__WEBPACK_IMPORTED_MODULE_2__["default"](ownCarouselElem, {
    itemPerRow: 2,
    itemSize: 50,
    responsive: {
      600: [2, 50],
