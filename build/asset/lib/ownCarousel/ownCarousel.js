Object.prototype.ownCarousel = function (options) {
    ...
    this.picker = this.querySelector(".own-carousel__picker");
    this.tabs = this.querySelector(".own-carousel__tabs");
    ...
    //         elem.classList.add('ui-thumb');
    //         this.pickerItems.push(elem);
    //         this.tabs.appendChild(elem);
    //     }
    //     this.activePickerItem = this.pickerItems[0];
    //     this.pickerItems[0].classList.add('active');
    // }
    ...
    this.translateSlide = () => {
        ...
        this.pickerItems[this.index].classList.add('active');
        this.activePickerItem = this.pickerItems[this.index];
    };
