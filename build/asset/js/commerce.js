...
/***/ "./asset/components/UI/ui-rangeBar/rangeBar.js":
/*!*****************************************************!*\
  !*** ./asset/components/UI/ui-rangeBar/rangeBar.js ***!
  \*****************************************************/
...
var RangeBarInt = function RangeBarInt(parent, output) {
  this.wrapper = parent;
  ...
  this.sliderTo = parent.querySelector('[data-range="slider-to"]'); // this.minGap = 10;
...
RangeBarInt.prototype = {
  ...
  updateValueFrom: function updateValueFrom(rawValue) {
    var value = parseInt(rawValue, 10);
    value + this.minGap <= this.valueTo ? this.valueFrom = value : this.valueFrom = this.valueTo;
  },
  updateValueTo: function updateValueTo(rawValue) {
    var value = parseInt(rawValue, 10);
  ...
  updateElementsFrom: function updateElementsFrom() {
    ...
    this.inputFrom.innerText = this.output === 'float' ? this.setFloatValue(this.valueFrom) : this.valueFrom;
  },
  updateElementsTo: function updateElementsTo() {
    this.sliderTo.value = this.valueTo;
    this.inputTo.value = this.valueTo;
    this.inputTo.innerText = this.output === 'float' ? this.setFloatValue(this.valueTo) : this.valueTo;
  },
  setFloatValue: function setFloatValue(value) {
    return (value / 1000000).toFixed(1);
  },
  onInputFrom: function onInputFrom(value) {
    this.updateValueFrom(value);
    this.updateElementsFrom();
    this.passValueFrom();
  },
  onInputTo: function onInputTo(value) {
...
Combobox.prototype = {
  ...
  resetCombobox: Lib_combobox_combobox_js__WEBPACK_IMPORTED_MODULE_0__.resetCombobox,
...
/***/ "./asset/components/UI/ui-select/multiCombobox.js":
/*!********************************************************!*\
  !*** ./asset/components/UI/ui-select/multiCombobox.js ***!
  \********************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var Lib_multiCombobox_multiCombobox_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! Lib/multiCombobox/multiCombobox.js */ "./asset/lib/multiCombobox/multiCombobox.js");

var MultiCombobox = Lib_multiCombobox_multiCombobox_js__WEBPACK_IMPORTED_MODULE_0__.multiCombobox;
MultiCombobox.prototype = {
  ...
  resetCombobox: Lib_multiCombobox_multiCombobox_js__WEBPACK_IMPORTED_MODULE_0__.resetCombobox,
  onOptionChecked: Lib_multiCombobox_multiCombobox_js__WEBPACK_IMPORTED_MODULE_0__.onOptionChecked,
  selectOption: Lib_multiCombobox_multiCombobox_js__WEBPACK_IMPORTED_MODULE_0__.selectOption,
  unselectOption: Lib_multiCombobox_multiCombobox_js__WEBPACK_IMPORTED_MODULE_0__.unselectOption,
  onKeydown: Lib_multiCombobox_multiCombobox_js__WEBPACK_IMPORTED_MODULE_0__.onKeydown,
  onComboboxBlur: Lib_multiCombobox_multiCombobox_js__WEBPACK_IMPORTED_MODULE_0__.onComboboxBlur,
  onListboxMouseDown: Lib_multiCombobox_multiCombobox_js__WEBPACK_IMPORTED_MODULE_0__.onListboxMouseDown,
  onOptionFocused: Lib_multiCombobox_multiCombobox_js__WEBPACK_IMPORTED_MODULE_0__.onOptionFocused,
  updateOutput: Lib_multiCombobox_multiCombobox_js__WEBPACK_IMPORTED_MODULE_0__.updateOutput,
  updateValue: Lib_multiCombobox_multiCombobox_js__WEBPACK_IMPORTED_MODULE_0__.updateValue,
  destroy: Lib_multiCombobox_multiCombobox_js__WEBPACK_IMPORTED_MODULE_0__.destroy,
  handleEvent: Lib_multiCombobox_multiCombobox_js__WEBPACK_IMPORTED_MODULE_0__.handleEvent
};
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (MultiCombobox);

/***/ }),

/***/ "./asset/components/commerceFilter/commerceFilter.js":
/*!***********************************************************!*\
  !*** ./asset/components/commerceFilter/commerceFilter.js ***!
  \***********************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
var CommerceFilter = function CommerceFilter(elem) {
...
CommerceFilter.prototype = {
  ...
  hideFilter: function hideFilter() {
    ...
    setTimeout(function () {
      _this.filter.classList.remove('close');
    }, 1000);
  },
  handleEvent: function handleEvent(e) {
    switch (e.type) {
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (CommerceFilter);

/***/ }),

/***/ "./asset/components/map/map.js":
/*!*************************************!*\
  !*** ./asset/components/map/map.js ***!
  \*************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
Map.prototype = {
  init: function init() {
    ...
    window.ymaps.ready(function () {
      _this.map = new window.ymaps.Map(_this.id, {
        center: _this.center,
        zoom: _this.zoom,
        controls: []
      }, {
    ...
    window.ymaps.ready(function () {
      var mapCenter = _this.map.container.getMapSize()[1] / 2;

      _this.map.controls.add('geolocationControl', {
        position: {
          top: "calc(".concat(mapCenter, "px - 47px)"),
          right: '1em'
        }
      });
      ...
      _this.map.controls.add('zoomControl', {
        size: 'small',
        position: {
          top: "calc(".concat(mapCenter, "px - 14px)"),
          right: '1em'
        }
      });
    }); // window.ymaps.ready(() => {
      ...
      '<div class="placemark"><img src="../asset/images/build/{{ properties.objectData.id }}/thumb/1.jpg"></div>', {
        build: function build() {
          ...
          this.getData().geoObject.events.add('mouseenter', function () {
            _this3.getParentElement().querySelector('.placemark').classList.add('is-hover');
          });
          this.getData().geoObject.events.add('mouseleave', function () {
            _this3.getParentElement().querySelector('.placemark').classList.remove('is-hover');
          });
        }
      });
      _this2.iconLayout = IconLayout;
    });
  },
  createStaticPointLayout: function createStaticPointLayout() {
    var _this4 = this;

    window.ymaps.ready(function () {
      var StaticPointLayout = window.ymaps.templateLayoutFactory.createClass( // eslint-disable-line
      '<div class="placepoint"><svg class="icon" focusable="false"><use href="#icon-16-see"/></svg></div>');
      _this4.StaticPointLayout = StaticPointLayout;
    });
  },
  createBalloonLayout: function createBalloonLayout() {
    var _this5 = this;
  ...
  createObjectCollection: function createObjectCollection() {
    var _this6 = this;

    window.ymaps.ready(function () {
      _this6.objectCollection = new window.ymaps.GeoObjectCollection();

      _this6.objectCollection.events.add('click', function (e) {
  ...
  clearObjectCollection: function clearObjectCollection() {
    this.objectCollection.removeAll();
  },
  addObjectInObjectCollection: function addObjectInObjectCollection(objectData) {
    var _this7 = this;

    window.ymaps.ready(function () {
      _this7.objectCollection.add(new window.ymaps.Placemark(objectData.coords, {
...
/***/ "./asset/components/tablistView/tablistView.js":
/*!*****************************************************!*\
  !*** ./asset/components/tablistView/tablistView.js ***!
  \*****************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
TablistView.prototype = {
  ...
  getFilterBar: function getFilterBar() {
    this.filterBar = document.querySelector('.panellistFilter .active .filter-bottom');
  },
  hideFilterBar: function hideFilterBar() {
    var _this = this;

    setTimeout(function () {
      _this.filterBar.classList.remove('fixed');
    }, 1000);
  },
  showFilterBar: function showFilterBar() {
    var _this2 = this;

    setTimeout(function () {
      _this2.filterBar.classList.add('fixed');
    }, 1000);
  },
  setStateFilterBar: function setStateFilterBar() {
    this.getFilterBar();
    this.activePanel.getAttribute('aria-labelledby') === 'tab-map' ? this.showFilterBar() : this.hideFilterBar();
  }
};
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (TablistView);

/***/ }),

/***/ "./asset/components/tabs/tabs.js":
/*!***************************************!*\
  !*** ./asset/components/tabs/tabs.js ***!
  \***************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var Lib_tabs_tabs_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! Lib/tabs/tabs.js */ "./asset/lib/tabs/tabs.js");

var Tabs = Lib_tabs_tabs_js__WEBPACK_IMPORTED_MODULE_0__.tabs;
Tabs.prototype = {
  constructor: Tabs,
  init: Lib_tabs_tabs_js__WEBPACK_IMPORTED_MODULE_0__.init,
  setListeners: Lib_tabs_tabs_js__WEBPACK_IMPORTED_MODULE_0__.setListeners,
  activateTab: Lib_tabs_tabs_js__WEBPACK_IMPORTED_MODULE_0__.activateTab,
  deactivateTab: Lib_tabs_tabs_js__WEBPACK_IMPORTED_MODULE_0__.deactivateTab,
  showPanel: Lib_tabs_tabs_js__WEBPACK_IMPORTED_MODULE_0__.showPanel,
  hidePanel: Lib_tabs_tabs_js__WEBPACK_IMPORTED_MODULE_0__.hidePanel,
  focusTab: Lib_tabs_tabs_js__WEBPACK_IMPORTED_MODULE_0__.focusTab,
  handleEvent: Lib_tabs_tabs_js__WEBPACK_IMPORTED_MODULE_0__.handleEvent,
  onkeydown: Lib_tabs_tabs_js__WEBPACK_IMPORTED_MODULE_0__.onkeydown,
  getPanelsId: Lib_tabs_tabs_js__WEBPACK_IMPORTED_MODULE_0__.getPanelsId,
  setHeightPanellist: Lib_tabs_tabs_js__WEBPACK_IMPORTED_MODULE_0__.setHeightPanellist
};
...
/***/ "./asset/lib/multiCombobox/multiCombobox.js":
/*!**************************************************!*\
  !*** ./asset/lib/multiCombobox/multiCombobox.js ***!
  \**************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony export */   "handleEvent": () => (/* binding */ handleEvent),
/* harmony export */   "init": () => (/* binding */ init),
/* harmony export */   "multiCombobox": () => (/* binding */ multiCombobox),
/* harmony export */   "onComboboxBlur": () => (/* binding */ onComboboxBlur),
/* harmony export */   "onKeydown": () => (/* binding */ onKeydown),
/* harmony export */   "onListboxMouseDown": () => (/* binding */ onListboxMouseDown),
/* harmony export */   "onOptionChecked": () => (/* binding */ onOptionChecked),
...
/* harmony import */ var Lib_keyActions_KeysActions__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! Lib/keyActions/KeysActions */ "./asset/lib/keyActions/KeysActions.js");
...
function multiCombobox(elem) {
  ...
  this.mapSelected = new Map(); // state combobox

  this.open = false; // this.optionSelectedIndex = 0;
...
function resetCombobox() {
  ...
  this.mapSelected.forEach(function (vale, key) {
...
function onOptionChecked(option) {
...
function updateOutput() {
  ...
  if (this.mapSelected.size > 1) {
    output = "".concat(Array.from(this.mapSelected)[0][1], ",..(").concat(this.mapSelected.size, ")");
  }
...
function updateValue() {
  var values = [];
  this.mapSelected.forEach(function (value) {
    values.push(value);
  });
...
function onKeydown(e) {
  var max = this.arrayOptions.length - 1;
  var action = (0,Lib_keyActions_KeysActions__WEBPACK_IMPORTED_MODULE_10__.getActionFromKey)(e, this.open);

  switch (action) {
    case Lib_keyActions_KeysActions__WEBPACK_IMPORTED_MODULE_10__.KeysActions.Next:
    case Lib_keyActions_KeysActions__WEBPACK_IMPORTED_MODULE_10__.KeysActions.Last:
    case Lib_keyActions_KeysActions__WEBPACK_IMPORTED_MODULE_10__.KeysActions.First:
    case Lib_keyActions_KeysActions__WEBPACK_IMPORTED_MODULE_10__.KeysActions.Previous:
      e.preventDefault();
      return this.onOptionFocused((0,Lib_keyActions_KeysActions__WEBPACK_IMPORTED_MODULE_10__.getUpdatedIndex)(this.optionFocusedIndex, max, action));

    case Lib_keyActions_KeysActions__WEBPACK_IMPORTED_MODULE_10__.KeysActions.Space:
      e.preventDefault();
      return this.toogleOptions(e);

    case Lib_keyActions_KeysActions__WEBPACK_IMPORTED_MODULE_10__.KeysActions.CloseSelect:
      e.preventDefault();
      this.onOptionChecked(e);
      return this.toogleOptions(e);

    case Lib_keyActions_KeysActions__WEBPACK_IMPORTED_MODULE_10__.KeysActions.Close:
      e.preventDefault();
      return this.toogleOptions(e);

    case Lib_keyActions_KeysActions__WEBPACK_IMPORTED_MODULE_10__.KeysActions.Open:
      e.preventDefault();
      return this.toogleOptions(e);

    case Lib_keyActions_KeysActions__WEBPACK_IMPORTED_MODULE_10__.KeysActions.Blur:
      return this.closeOptions();
...
/* harmony export */   "deactivateTab": () => (/* binding */ deactivateTab),
/* harmony export */   "focusTab": () => (/* binding */ focusTab),
/* harmony export */   "getPanelsId": () => (/* binding */ getPanelsId),
/* harmony export */   "handleEvent": () => (/* binding */ handleEvent),
/* harmony export */   "hidePanel": () => (/* binding */ hidePanel),
/* harmony export */   "init": () => (/* binding */ init),
/* harmony export */   "onkeydown": () => (/* binding */ onkeydown),
/* harmony export */   "setHeightPanellist": () => (/* binding */ setHeightPanellist),
...
/* harmony import */ var Styles_commerce_css__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! Styles/commerce.css */ "./asset/styles/commerce.css");
...
/* harmony import */ var _components_tabs_tabs__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./components/tabs/tabs */ "./asset/components/tabs/tabs.js");
/* harmony import */ var _components_commerceFilter_commerceFilter__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./components/commerceFilter/commerceFilter */ "./asset/components/commerceFilter/commerceFilter.js");
/* harmony import */ var _components_tablistView_tablistView__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./components/tablistView/tablistView */ "./asset/components/tablistView/tablistView.js");
/* harmony import */ var _components_UI_ui_rangeBar_rangeBar__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./components/UI/ui-rangeBar/rangeBar */ "./asset/components/UI/ui-rangeBar/rangeBar.js");
/* harmony import */ var _components_UI_ui_select_multiCombobox__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./components/UI/ui-select/multiCombobox */ "./asset/components/UI/ui-select/multiCombobox.js");
/* harmony import */ var _components_UI_ui_select_combobox__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./components/UI/ui-select/combobox */ "./asset/components/UI/ui-select/combobox.js");
...
selects.forEach(function (item) {
  var select = new _components_UI_ui_select_combobox__WEBPACK_IMPORTED_MODULE_10__["default"](item);
  select.init();
});
var multiSelects = document.querySelectorAll('.js-multiSelect');
multiSelects.forEach(function (item) {
  var multiSelect = new _components_UI_ui_select_multiCombobox__WEBPACK_IMPORTED_MODULE_9__["default"](item);
  multiSelect.init();
});
var rangeBarIntElem = document.querySelectorAll('.js-rangeBarInt');
var rangeBarFloatElem = document.querySelectorAll('.js-rangeBarFloat');
rangeBarIntElem.forEach(function (item) {
  var rangeBar = new _components_UI_ui_rangeBar_rangeBar__WEBPACK_IMPORTED_MODULE_8__["default"](item);
  rangeBar.init();
  return rangeBar;
});
rangeBarFloatElem.forEach(function (item) {
  var rangeBar = new _components_UI_ui_rangeBar_rangeBar__WEBPACK_IMPORTED_MODULE_8__["default"](item, 'float');
  rangeBar.init();
  return rangeBar;
});
var tablistsView = document.querySelectorAll('.js-tablistView');
tablistsView.forEach(function (item) {
  var tablistView = new _components_tablistView_tablistView__WEBPACK_IMPORTED_MODULE_7__["default"](item);
  tablistView.init();
  return tablistView;
});
var filterElem = document.querySelector('.js-commerceFilter');
var filter = new _components_commerceFilter_commerceFilter__WEBPACK_IMPORTED_MODULE_6__["default"](filterElem);
filter.init();
var tablists = document.querySelectorAll('.js-tablist');
tablists.forEach(function (item) {
  var tablist = new _components_tabs_tabs__WEBPACK_IMPORTED_MODULE_5__["default"](item);
  tablist.init();
  return tablist;
});
var commerceFilter = document.querySelector('.commerceFilter');
var btn = document.querySelector('.commerceResult .commerceControls');
var btnObserve = document.querySelector('.commerceControls');

var callback = function callback(entries) {
  entries.forEach(function (entry) {
    entry.isIntersecting ? commerceFilter.classList.remove('sticky') : commerceFilter.classList.add('sticky');
    entry.isIntersecting ? btn.classList.remove('is-show') : btn.classList.add('is-show');
  });
};
...
var map = new _components_map_map__WEBPACK_IMPORTED_MODULE_4__["default"]('ymap', 17, [44.898317, 37.354456]);
var testOdjectData = {
  id: 1,
  coords: [44.898317, 37.354456],
  name: 'Ям Голден Лайн',
