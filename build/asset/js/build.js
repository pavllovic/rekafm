...
YMap.prototype = {
  ...
  addStaticPointOnMap: function addStaticPointOnMap(objectData) {
    ...
    window.ymaps.ready(function () {
      ...
      _this9.map.setCenter(objectData.coords, 17);
    });
  },
...
/***/ "./asset/components/showList/showList.js":
/*!***********************************************!*\
  !*** ./asset/components/showList/showList.js ***!
  \***********************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var Lib_showList_showList_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! Lib/showList/showList.js */ "./asset/lib/showList/showList.js");

var ShowList = Lib_showList_showList_js__WEBPACK_IMPORTED_MODULE_0__.showList;
ShowList.prototype = {
  constructor: ShowList,
  init: Lib_showList_showList_js__WEBPACK_IMPORTED_MODULE_0__.init,
  setListeners: Lib_showList_showList_js__WEBPACK_IMPORTED_MODULE_0__.setListeners,
  openList: Lib_showList_showList_js__WEBPACK_IMPORTED_MODULE_0__.openList,
...
/***/ "./asset/lib/showList/showList.js":
/*!****************************************!*\
  !*** ./asset/lib/showList/showList.js ***!
  \****************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
function showList(elem) {
  ...
  this.btnHeight = parseInt(window.getComputedStyle(this.outerList).paddingBottom.slice(0, -2), 10);
  this.state = false;
}
function init() {
  this.setListeners();
  this.getInitalHeightInnerList();
  this.list.style.setProperty('--inner-height', "".concat(this.initalHeightInnerList, "px"));
...
function openList() {
  this.outerList.style.setProperty('--outer-height', "".concat(this.listFullHeight + this.btnHeight, "px"));
  this.list.style.setProperty('--inner-height', "".concat(this.listFullHeight, "px"));
  this.wrap.classList.add('open');
  this.state = true;
}
function closeList() {
  this.outerList.style.setProperty('--outer-height', "".concat(this.initalHeightOuterList, "px"));
  this.list.style.setProperty('--inner-height', "".concat(this.initalHeightInnerList, "px"));
...
function getInitalHeightInnerList() {
  var _this = this;

  var items = this.list.querySelectorAll('li');
  var marginBottom = parseInt(window.getComputedStyle(items[0]).marginBottom.slice(0, -2), 10);
  var maxHeight = this.initalHeightOuterList - this.btnHeight;
  this.initalHeightInnerList = 0;
  items.forEach(function (item) {
    var step = item.offsetHeight + marginBottom;

    if (_this.initalHeightInnerList + step < maxHeight) {
...
var initMap = function initMap() {
  var map = new _components_map_map__WEBPACK_IMPORTED_MODULE_2__["default"]('ymap', {
    zoom: 17,
    center: [0, 0]
  });
  map.init();
