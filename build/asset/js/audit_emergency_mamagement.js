...
var initCardTariff = function initCardTariff() {
  var cardsTariffElements = document.querySelectorAll('.js-cardTariff');

  if (cardsTariffElements.length !== 0) {
    var cardsTariff = Array.from(cardsTariffElements).map(function (item) {
      var card = new _components_showList_showList__WEBPACK_IMPORTED_MODULE_5__["default"](item);
      card.init();
      return card;
    });
...
var initCarouselTariff = function initCarouselTariff() {
  var carouselTariffElem = document.querySelector('.js-carousel');

  if (carouselTariffElem) {
    var carouselTariff = new _components_carousel_carousel_js__WEBPACK_IMPORTED_MODULE_4__["default"](carouselTariffElem);
    carouselTariff.init();
