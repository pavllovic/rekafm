...
/***/ "./asset/components/nav/updateHeightNav.js":
/*!*************************************************!*\
  !*** ./asset/components/nav/updateHeightNav.js ***!
  \*************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
var updateHeightMenu = function updateHeightMenu() {
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (updateHeightMenu);
...
function openSubmenu(item) {
  if (this.openItem) this.closeSubmenu(); // const menu = item.nextElementSibling;

  var menu = item.querySelector('[data-dropdown="panel"]');
...
function closeSubmenu() {
  ...
  var menu = this.openItem.querySelector('[data-dropdown="panel"]');
...
FormValidator.prototype = {
  ...
  invalidInputHandler: function invalidInputHandler(input) {
    ...
    if (!input.validity[typeError]) {
      var _this$errorMessage$na;

      var nameError = this.getInputError(input);
      var msg = (_this$errorMessage$na = this.errorMessage[name]) === null || _this$errorMessage$na === void 0 ? void 0 : _this$errorMessage$na[nameError];
...
function _sendFormJSON() {
  _sendFormJSON = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2(form, data) {
    var objData, url, method, options, response;
...
/* harmony import */ var Styles_common_css__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! Styles/common.css */ "./asset/styles/common.css");
/* harmony import */ var imask__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! imask */ "./node_modules/imask/esm/index.js");
/* harmony import */ var _components_nav_nav_js__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./components/nav/nav.js */ "./asset/components/nav/nav.js");
/* harmony import */ var _components_menu_dropdownMenu__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./components/menu/dropdownMenu */ "./asset/components/menu/dropdownMenu.js");
/* harmony import */ var _components_ticker_ticker__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./components/ticker/ticker */ "./asset/components/ticker/ticker.js");
/* harmony import */ var _components_modal_modal__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./components/modal/modal */ "./asset/components/modal/modal.js");
/* harmony import */ var _components_customCursor_customCursor_js__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ./components/customCursor/customCursor.js */ "./asset/components/customCursor/customCursor.js");
...
var initInputMask = function initInputMask() {
  var elements = document.querySelectorAll('.js-inputPhone');
  var phoneMaskOption = {
    mask: '+{7} (000) 000-00-00'
  };
  elements.forEach(function (elem) {
    var input = (0,imask__WEBPACK_IMPORTED_MODULE_7__["default"])(elem, phoneMaskOption);
    return input;
  });
};
...
var initTicker = function initTicker() {
  ...
  arrTickers.forEach(function (item) {
    var ticker = new _components_ticker_ticker__WEBPACK_IMPORTED_MODULE_10__["default"](item);
    ticker.init();
  });
};
